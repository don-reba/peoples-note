...
public:
	...
	Thrift::Protocol::TString EDAM_COMMERCE_SERVICE_TRIAL;
	Thrift::Protocol::TString EDAM_COMMERCE_SERVICE_GROUP;
	Thrift::Protocol::TString EDAM_COMMERCE_SERVICE_CYBERSOURCE;
	Thrift::Protocol::TString EDAM_COMMERCE_DEFAULT_CURRENCY_COUNTRY_CODE;
	...
	__int32 EDAM_NOTEBOOK_STACK_LEN_MIN;
	__int32 EDAM_NOTEBOOK_STACK_LEN_MAX;
	Thrift::Protocol::TString EDAM_NOTEBOOK_STACK_REGEX;
	...
	__int64 EDAM_USER_UPLOAD_LIMIT_FREE;
	__int64 EDAM_USER_UPLOAD_LIMIT_PREMIUM;
