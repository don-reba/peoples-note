...
void Tag::Read(Thrift::Protocol::TProtocol & iprot)
{
	...
	for (;;)
	{
		...
		case 3:
			if (field.GetType() == Thrift::Protocol::TypeString)
			{
				iprot.ReadString(this->parentGuid);
...
void Tag::Write(Thrift::Protocol::TProtocol & oprot)
{
	Thrift::Protocol::TStruct struc;
	struc.SetName(L"Tag");
	...
	if (__isset.parentGuid)
	{
		Thrift::Protocol::TField field;
		field.SetName(L"parentGuid");
		field.SetType(Thrift::Protocol::TypeString);
		field.SetID(3);
		oprot.WriteFieldBegin(field);
