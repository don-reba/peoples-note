...
void EDAMSystemException::Read(Thrift::Protocol::TProtocol & iprot)
{
...
void EDAMSystemException::Write(Thrift::Protocol::TProtocol & oprot)
{
	Thrift::Protocol::TStruct struc;
	struc.SetName(L"EDAMSystemException");
